defmodule Validation.RequestParameterValidationTest do
  ...
  test "request has invalid url params" do
    response = Validation.RequestParameterValidation.has_valid_parameters(%{"glob" => ["£££"], "id" => "£££"})
    assert response == {:error, :invalid_url_params}
  end

   test "request has valid url params" do
    response = Validation.RequestParameterValidation.has_valid_parameters(%{"glob" => ["uuid-1"], "id" => "uuid-1"})
